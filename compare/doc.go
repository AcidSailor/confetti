...
// tokens. A BlockDelim body is written between its delimiters, matching package
// render. Use package render on the remediation tree to produce executable CLI.
package compare
