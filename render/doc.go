...
// preserved exactly. An empty BlockDelim body closes on the opening line when
// schema.Node.InlineBlock confirms the round trip. A schema.SectionExit token closes each section that
// declares one.
//
